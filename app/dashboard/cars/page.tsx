  ...
  return (
    <section className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 p-4 bg-accent rounded-lg border">
        ...
        <Button asChild variant="outline" className="font-medium flex items-center gap-2">
            ...
            <TableBody>
              {cars.map((car) => (
                <TableRow key={car.id}>
                  ...
                  <TableCell className="text-muted-foreground">{car.slug}</TableCell>
                  <TableCell>Rp {car.price_per_day.toLocaleString("id-ID")}</TableCell>
