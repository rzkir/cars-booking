...
export default async function Page() {
  ...
  return (
    <main className="flex-1 pt-32 pb-24 px-6 bg-[#fcfcfc] min-h-screen">
      <div className="max-w-7xl mx-auto">
        {/* User Profile Header Summary */}
        <section
          aria-labelledby="profile-summary-heading"
          className={`bg-white rounded-[2.5rem] p-8 md:p-10 mb-10 ${cardShadow}`}
        >
          <div className="flex flex-col md:flex-row items-center gap-8 justify-between">
            <div className="flex flex-col md:flex-row items-center gap-6">
              <div className="w-24 h-24 rounded-full overflow-hidden border-4 border-orange-50 shadow-lg">
                <Image
              ...
              <div className="text-center md:text-left space-y-1">
                ...
                <div className="flex flex-wrap justify-center md:justify-start gap-3 items-center">
                  <span className="px-3 py-1 bg-[#1a1a1a] text-[#FF9500] text-[10px] font-black uppercase tracking-widest rounded-full">
                    {membershipLabel}
                  </span>
                  {user.email && (
            ...
            <a
              ...
              className="px-6 py-3 bg-gray-50 text-[#1a1a1a] rounded-xl font-black text-xs hover:bg-gray-100 transition-all border border-gray-100 flex items-center gap-2"
            >
        ...
        >
          <div className="flex gap-10 overflow-x-auto pb-px scrollbar-hide">
            <a
              href="#"
              id="nav-profile-tab"
              className="pb-4 text-sm font-black uppercase tracking-widest text-gray-300 hover:text-gray-500 whitespace-nowrap"
            >
              Profil
            </a>
            <a
              href="#"
              id="nav-history-tab"
              className="pb-4 text-sm font-black uppercase tracking-widest text-[#FF9500] border-b-2 border-[#FF9500] whitespace-nowrap"
            >
              Riwayat Booking
            </a>
            <a
