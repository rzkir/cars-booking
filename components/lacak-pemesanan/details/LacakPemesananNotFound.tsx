  ...
  return (
    <div className="flex flex-col gap-12">
        ...
        <div className="relative z-10 px-6 space-y-8">
          ...
          <div className="mx-auto max-w-xl space-y-4">
            <h2 className="text-2xl font-black tracking-tight md:text-3xl lg:text-4xl">
              Data Bookings Tidak Ditemukan
            </h2>
            <p className="text-sm font-medium leading-relaxed text-gray-500 md:text-base">
              Maaf, data bookings untuk mobil yang Anda cari tidak tersedia atau
              mungkin sudah dihapus dari database kami. Mari bantu Anda
              menemukan armada lain yang serupa.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="rounded-3xl bg-white py-12 shadow-sm ring-1 ring-gray-100 md:py-14">
        <div className="mx-auto max-w-full-sm xl:container px-6">
          <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
            {[
              {
                icon: <Link2 className="h-8 w-8" />,
                title: "Periksa Kembali Id Bookings",
                desc: "Pastikan id bookings yang Anda masukkan sudah benar.",
              },
              {
